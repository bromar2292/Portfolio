            ...
            <div className="pg">
              ...
              <div>
                <div className="work-container">
                  ...
                  <div className="txt">
                    <li className="txt">
                      Currently progressing with React Js by going through a
                      Udemy course which highlights test-driven development and
                      Redux.
                    </li>
                  </div>
                </div>
                <div className="work-container">
                  ...
                  <div className="txt">
                    ...
                    <li>
                      Reformated the entire mobile development roadmap to fit
                      with deadlines then break down into sprints.
                    </li>
                    <li>
                ...
                <div className="work-container">
                  ...
                  <div className="txt">
                    ...
                    <li>
                      Continually building websites by copying other websites
                      Like for like, considerably sharpened my javascript and
                      sass skills.
                    </li>
                  </div>
                </div>
                <div className="work-container">
                  ...
                  <div className="txt">
                    <li className="txt">
                      From 500 down to 23, earned my place and Graduated from
                      the legendary School of Code 16 week intensive bootcamp.
                    </li>

                    <li className="txt">
                      Learnt the fundamentals of full-stack development with
                      weekly talks and presentations from industry
                      professionals.
                    </li>
                    <li className="txt">
                ...
                <div className="work-container">
                  ...
                  <div className="txt">
                    <li>
                      Much like coding, djing is a skill you are always
                      improving on theres always more music/ ways to code.
                    </li>
                    <li>
